...
function
cart_office_shippable_off(checkbox, id){
  var emt = document.getElementById("product_shippable");
  if (checkbox.checked) {
    emt.checked = false;
  } else {
    emt.checked = true;
...
function
cart_office_digital_media_off(checkbox, id){
  var emt = document.getElementById("product_digital_media");
  if (checkbox.checked) {
    emt.checked = false;
  } else {
    emt.checked = true;
